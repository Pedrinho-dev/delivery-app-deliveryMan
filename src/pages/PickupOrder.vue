<template>
    <v-container class="container">
        ...
        <div v-if="order" class="order-info">
            ...
            <v-btn color="primary" size="large" block class="mt-4" @click="confirmPickup">
...
async function loadMapRoute() {
    ...
    const driverCoords = await getCoordinatesFromAddress(order.value.locDeliveryMan);
    ...
    if (driverCoords && clientLoc) {
        ...
        destinationAddress.value = await getAddressFromCoordinates(clientLoc.lat, clientLoc.lng);
    } else {
